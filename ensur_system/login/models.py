...
class YwryAgent(models.Model):
    customer = models.OneToOneField('YwryCustomer', models.DO_NOTHING, primary_key=True)
...
class YwryPassenger(models.Model):
    ...
    customer = models.ForeignKey(YwryCustomer, models.DO_NOTHING)
...
class YwryPayment(models.Model):
    ...
    customer = models.ForeignKey(YwryCustomer, models.DO_NOTHING, blank=True, null=True)
